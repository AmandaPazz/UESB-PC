...
* Funcao...........: Funciona como o controlador dos elementos da página principal do aplicativo (cena que contém os trens)
****************************************************************/
...
/****************************************************************
  ...
  /****************************************************************
 * Metodo: initialize
 * Funcao: inicializa a interface gráfica e configura o estado dos elementos na cena dos trilhos
 ...
 ****************************************************************/
  ...
  AnimationTimer animacao1 = new AnimationTimer() {
    ...
    public void handle(long now) {
      ...
      //Print no terminal para ter um controle dos valores 
      System.out.println(tr.getSpeedY());
      ...
      //Executa a animação específica do caso 1, passando os objetos dos trens como parâmetros
