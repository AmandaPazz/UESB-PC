...
public class ThreadTrainRed extends Thread {
    ...
    /****************************************************************
     * Metodo: run
     * Funcao: define o que a thread vai controlar que nesse caso e o movimento continuo do trem vermelho
     * Parametros:void
     * Retorno: void
     ****************************************************************/
    @Override
    ...
    public ThreadTrainRed(ImageView imageTrain, int posicao, Slider slider) {
        ...
        switch (posicao) {
            case 1: {
                ...
                if (this.getImageTrain().getLayoutY() < 20 && this.getImageTrain().getLayoutY() >= -29) {
                    ...
                    this.getImageTrain().setLayoutX(390);
            ...
            case 3: {
                ...
                else if (this.getImageTrain().getLayoutY() <= 133 && this.getImageTrain().getLayoutY() > 22) {
                    this.getImageTrain().setRotate(135);
                    this.getImageTrain().setLayoutY(this.getImageTrain().getLayoutY() - this.getSpeedY());
                    this.getImageTrain().setLayoutX(this.getImageTrain().getLayoutX() - this.getSpeedX());
                } // fim do oitavo if
                else if (this.getImageTrain().getLayoutY() <= 22 && this.getImageTrain().getLayoutY() > -47) {
                    this.getImageTrain().setRotate(180);
                    this.getImageTrain().setLayoutY(this.getImageTrain().getLayoutY() - this.getSpeedY());
                } // fim do nono if
                else {
